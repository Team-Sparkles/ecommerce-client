...
var getTilesSuccess = function getTilesSuccess(data) {
  var showTilesHtml = handlebars({ items: data.items });
  $('#marketplace').html('');
  $('#marketplace').html(showTilesHtml);
};
var getTilesError = function getTilesError(error) {}
...
;var showAlert = function showAlert(context, msgBold, msgText, fadeTime) {
...
var ordersUi = __webpack_require__(10);
var orderDetailHandlebars = __webpack_require__(40);
...
var addHandlers = function addHandlers() {
  ...
  $('#orders-close-button').on('click', function () {
...
var onShowOrder = function onShowOrder() {
  ...
  ordersApi.showOrder(orderId).then(function (response) {
    ...
    var orderDetailHtml = orderDetailHandlebars({ items: response.order.items });
...
var addAlert = function addAlert() {
...
var onCreateOrder = function onCreateOrder() {
  ...
  ordersApi.createOrder(data).then(ordersUi.createOrderSuccess).catch(ordersUi.createOrderError);
};

var processUpdateRequest = function processUpdateRequest() {
  if (store.user) {
    ...
    ordersApi.showOrder(orderId).then(function (response) {
      ...
      if (buttonClass === 'tile-cart-button') {
        ...
        // asked to remove
        var firstMatchIndex = itemsIdsOnlyArray.findIndex(function (item) {
          return item === itemId;
        });
...
var onUpdateOrder = function onUpdateOrder(orderId, data) {
...
var ui = __webpack_require__(2);
var cartItemsHandlebars = __webpack_require__(38);
var orderListHandlebars = __webpack_require__(39);
var ordersApi = __webpack_require__(7);

var showOrdersError = function showOrdersError(error) {
  // console.log('Error from showOrdersError is: ', error)
  ui.showAlert('danger', 'Warning!', 'Failed to connect to database', 3000);
};

var createOrderError = function createOrderError(error) {
  // console.log('Error from createOrderError is: ', error)
  ui.showAlert('danger', 'Warning!', 'Failed to connect to database', 3000);
};

var showOrderError = function showOrderError(error) {
  // console.log('Error from showOrderError is: ', error)
  ui.showAlert('danger', 'Warning!', 'Failed to connect to database', 3000);
};

var updateOrderError = function updateOrderError(error) {
  // console.log('Error from updateOrderError is: ', error)
  ui.showAlert('danger', 'Warning!', 'Failed to connect to database', 3000);
};

var updateOrderSuccess = function updateOrderSuccess(response) {
  displayOrders();
};
...
var displayOrders = function displayOrders() {
  ordersApi.showOrders().then(function (response) {
    if (response.orders.length > 0) {
      ...
      var orderListHtml = orderListHandlebars({ orders: response.orders });
...
var updateCartDetails = function updateCartDetails(order) {
  ...
  if (order.items.length > 0) {
    var cartItemsHtml = cartItemsHandlebars({ items: order.items });
    $('#cart-items').html('');
...
// load manifests
// scripts
// require('./assets/scripts/stripe-checkout.js')
...
var ordersEvents = __webpack_require__(9);
...
var getTiles = function getTiles() {
  api.getTilesSubmit().then(ui.getTilesSuccess).catch(ui.getTilesError);
};
...
var getTilesSubmit = function getTilesSubmit() {
  return $.ajax({
    method: 'GET',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div data-id=\""
    ...
    + "\" class=\"item-tile\">\n    <!-- <div class=\"item-image\"><img class=\"item-image\" src=\"https://i.imgur.com/k6krfm0.png\" alt=\"sample\"></div> -->\n    <div class=\"item-text\">\n      <h2>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h2>\n      <h3>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.dollarAmount : stack1), depth0))
    + "</h3>\n    </div>\n    <div class=\"item-cart-options\">\n        <!-- <form class=\"tile-cart\">\n            <select class=\"quantity-tab\">\n              <option value=\"1\" selected=\"selected\">1</option>\n              <option value=\"2\">2</option>\n              <option value=\"3\">3</option>\n              <option value=\"4\">4</option>\n              <option value=\"5\">5</option>\n            </select> -->\n            <h4><button class=\"tile-cart-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Add to Cart</button>\n          </h4>\n        <!-- </form> -->\n    </div>\n  </div>\n\n";
...
var addHandlers = function addHandlers() {
  ...
  $('.clear-auth-alert-modal').on('click', function () {
...
var onSignOut = function onSignOut(event) {
  ...
  ordersApi.deleteOrder(orderId).then(authApi.signOut).then(authUi.signOutSuccess).catch(authUi.signOutError);
  // .catch(console.error)
};
...
var signUpPasswordError = function signUpPasswordError(error) {
  // display error message and clear form fields
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr data-id=\""
    ...
    + "\" class=\"table-primary\">\n      <td><button class=\"remove-item-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"table-primary\">\n      <td><button class=\"show-past-order-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
